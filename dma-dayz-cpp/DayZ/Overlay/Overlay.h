...
class Overlay {
	...
	void drawAliveEntities(sf::RenderWindow* window, std::vector<DayZ::Entity*>* entities, DayZ::Camera* camera, DayZ::Scoreboard* scoreboard);
	void drawLoot(sf::RenderWindow* window, std::vector<DayZ::Entity*>* entities, DayZ::Camera* camera);
